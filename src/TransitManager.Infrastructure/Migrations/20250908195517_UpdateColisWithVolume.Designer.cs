...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20250908195517_UpdateColisWithVolume")]
    partial class UpdateColisWithVolume
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 9, 8, 19, 55, 13, 976, DateTimeKind.Utc).AddTicks(2744),
                            DoitChangerMotDePasse = false,
                            Email = "admin@transitmanager.com",
                            FuseauHoraire = "Europe/Paris",
                            Langue = "fr-FR",
                            MotDePasseHash = "$2a$11$T5rYK1C0WMtXwB6/WPpCBeObp2N4mjbmKmZjer8Z.0cu8NKy556ja",
                            Nom = "Administrateur",
