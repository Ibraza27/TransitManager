...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251202162555_AddDocumentsAndVehiculeFeatures")]
    partial class AddDocumentsAndVehiculeFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 2, 16, 25, 52, 784, DateTimeKind.Utc).AddTicks(2822),
