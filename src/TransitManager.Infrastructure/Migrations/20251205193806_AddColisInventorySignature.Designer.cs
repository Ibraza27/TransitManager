...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251205193806_AddColisInventorySignature")]
    partial class AddColisInventorySignature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 5, 19, 38, 3, 311, DateTimeKind.Utc).AddTicks(6176),
