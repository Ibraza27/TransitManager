...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251209184310_AddMessagingAndTimeline")]
    partial class AddMessagingAndTimeline
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 9, 18, 43, 8, 559, DateTimeKind.Utc).AddTicks(6195),
