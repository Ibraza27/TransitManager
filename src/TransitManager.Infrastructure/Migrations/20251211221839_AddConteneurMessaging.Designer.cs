...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251211221839_AddConteneurMessaging")]
    partial class AddConteneurMessaging
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 11, 22, 18, 36, 761, DateTimeKind.Utc).AddTicks(3990),
