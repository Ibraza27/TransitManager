...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251223214752_AddAddressFieldsToColisVehicule")]
    partial class AddAddressFieldsToColisVehicule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 23, 21, 47, 50, 878, DateTimeKind.Utc).AddTicks(3132),
