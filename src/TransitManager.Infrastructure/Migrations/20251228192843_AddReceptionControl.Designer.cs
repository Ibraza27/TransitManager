...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251228192843_AddReceptionControl")]
    partial class AddReceptionControl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 28, 19, 28, 40, 616, DateTimeKind.Utc).AddTicks(2000),
