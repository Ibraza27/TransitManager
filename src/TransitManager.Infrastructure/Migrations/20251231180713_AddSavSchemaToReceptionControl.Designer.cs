...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20251231180713_AddSavSchemaToReceptionControl")]
    partial class AddSavSchemaToReceptionControl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 31, 18, 7, 11, 435, DateTimeKind.Utc).AddTicks(4206),
