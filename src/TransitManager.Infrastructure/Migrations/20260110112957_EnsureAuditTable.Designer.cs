...
namespace TransitManager.Infrastructure.Migrations
{
    ...
    [Migration("20260110112957_EnsureAuditTable")]
    partial class EnsureAuditTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransitManager.Core.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Actif = true,
                            DateCreation = new DateTime(2026, 1, 10, 11, 29, 55, 729, DateTimeKind.Utc).AddTicks(7607),
